...
class StepperCheckpoint(QWidget):
    ...
    def paintEvent(self, paintEvent):
        ...
        if self.state == self.STATE_PASSIVE:
            ...
            painter.setBrush(QBrush(QColor(0, 200, 255, 120)))
        ...
        painter.drawText(QRectF(self.left, self.top, self.visualSize, self.visualSize), Qt.AlignCenter,
                         self.primaryText)
        painter.drawText(
            QRectF(self.left - self.visualSize, self.top + self.visualSize, self.visualSize * 3, self.visualSize / 2),
            Qt.AlignCenter, self.secondaryText)
